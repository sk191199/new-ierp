...
export const ROUTES = {
  ...
  crm: {
    ...
    opportunityNew: "/crm/opportunities/new",
  ...
  sales: {
    ...
    enquiryNew: "/sales/enquiries/new",
    enquiryEdit: (id: string) => `/sales/enquiries/${id}/edit`,
    quotations: "/sales/quotations",
      quotationNew: "/sales/quotations/new",
      quotationEdit: (id: string) => `/sales/quotations/${id}/edit`,
    projects: "/sales/projects",
    orders: "/sales/orders",
    invoices: "/sales/invoices",
    creditDebitNotes: "/sales/credit-debit-notes",
    deliveryOrders: "/sales/delivery-orders",
  },
  purchase: {
    root: "/purchase",
